...
![Daily News Screenshot](./public/screenshots/Home.png)
...
```bash
git clone https://github.com/badawy20oct/daily-news.git
cd daily-news
```
...
- LinkedIn: [Abdelrahman Badawy](https://www.linkedin.com/in/abdelrahman-badawy-469789204)
...
### Update Post
![Create Post](./public/screenshots/update-post.png)
...
Made with ❤️ by [Abdelrahman Badawy](https://github.com/badawy20oct)
