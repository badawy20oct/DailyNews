...
function CreatePostForm() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <h1 className="font-bold text-xl sm:text-2xl md:text-3xl text-blue-950 mb-4 sm:mb-6">Create New Post</h1>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:gap-4 md:gap-6">
        <div>
          <label htmlFor="title" className="block text-sm sm:text-base md:text-lg font-semibold text-blue-950 mb-2">
            Title
          </label>
          <input
            id="title"
        ...
        <div>
          <label htmlFor="content" className="block text-sm sm:text-base md:text-lg font-semibold text-blue-950 mb-2">
            Content
          </label>
          <textarea
            id="content"
        ...
        {links && links.length > 0 && (
          <div>
            <label className="block text-sm sm:text-base md:text-lg font-semibold text-blue-950 mb-2">
              Links
            </label>
        ...
        <div>
          <label htmlFor="add-link" className="block text-sm sm:text-base md:text-lg font-semibold text-blue-950 mb-2">
            Add Link
          </label>
        ...
        <div>
          <label htmlFor="category" className="block text-sm sm:text-base md:text-lg font-semibold text-blue-950 mb-2">
            Category
          </label>
          <select
            id="category"
